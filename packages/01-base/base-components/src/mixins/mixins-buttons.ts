...
import { primaryFontStack, buttonsLinksTokens, buttonReset, linkReset, zindex } from 'base-components'
...
export const buttonOutline = () => css`
  ...
  background: none;
  box-shadow: inset 0px 0px 0px 1px ${buttonsLinksTokens.buttonOutlineBorderCol}; /* use inset box-shadow instead of border to avoid larger element than non-border buttons */
